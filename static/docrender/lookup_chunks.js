/* Geometry-based paragraph boundaries for canonical document extraction. */
(function(global) {
  'use strict';
  var DEFAULT_OPTIONS = { drawRuns: true, drawWords: true, drawLines: false, drawEdges: false, linePairScore: 0.60 };
  var baseOptions = cloneOptions(DEFAULT_OPTIONS);
  ...
  function buildChunks(page, opts) {
    opts = mergeOptions(baseOptions, opts || {});
  ...
  global.LookupChunks = { buildLookupChunks: buildLookupChunks, applyLookupChunkParagraphBreaks: applyLookupChunkParagraphBreaks };
})(window);
