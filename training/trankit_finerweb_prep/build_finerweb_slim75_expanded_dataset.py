...
builder.DATASET_NAME = "finerweb_slim75_expanded"
builder.DATASET_DISPLAY_NAME = "slim75 expanded"
builder.DATASET_DESCRIPTION = (
    "Original fiNERweb labels are mapped through the expanded 75% FastText retained map. "
    "CONCEPT, TITLE, MEDIA, LAW, BIOMED, and RELIGIOUS_PRACTICE are included. "
...
builder.OUTPUT_BY_LANG = builder.DATASETS / "finerweb_slim75_expanded_by_language"
builder.OUTPUT_COMBINED = builder.DATASETS / "finerweb_slim75_expanded"
...
builder.RETAINED_MAP = (
    ...
    / "finerweb_selected_manual_seed_regions_threshold75_expanded_split_cultural_retained_tag_map.tsv"
)
