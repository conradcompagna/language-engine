...
builder.DATASET_NAME = "finerweb_slim60_concept_title"
builder.DATASET_DISPLAY_NAME = "slim60 concept/title"
builder.DATASET_DESCRIPTION = (
    "Original fiNERweb labels are mapped through the 60% FastText retained map with CONCEPT and TITLE restored. "
...
builder.OUTPUT_BY_LANG = builder.DATASETS / "finerweb_slim60_concept_title_by_language"
builder.OUTPUT_COMBINED = builder.DATASETS / "finerweb_slim60_concept_title"
...
builder.RETAINED_MAP = (
    ...
    / "finerweb_selected_manual_seed_regions_threshold60_concept_title_split_cultural_retained_tag_map.tsv"
)
