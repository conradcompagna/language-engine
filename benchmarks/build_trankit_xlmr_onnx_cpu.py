...
def build_task(
    ...
    *,
    ...
    try:
        ...
        hidden_size = int(
            getattr(config, "hidden_size", getattr(pipeline_obj._embedding_layers, "xlmr_dim", 768))
            or 768
        )
...
def main() -> int:
    ...
    parser.add_argument(
        "--force", action="store_true", help="delete existing ONNX task files before rebuilding"
    )
