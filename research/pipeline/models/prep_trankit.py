...
languages = [
    dict(src_dir="UD_Ancient_Greek-PTNK", train="grc_ptnk-ud-train.conllu", dev="grc_ptnk-ud-dev.conllu", prefix="grc", out="ancient_greek"),
    dict(src_dir="UD_Arabic-NYUAD",       train="ar_nyuad-ud-train.conllu",  dev="ar_nyuad-ud-dev.conllu",  prefix="ar",  out="arabic_nyuad"),
    dict(src_dir="UD_Hebrew-IAHLTwiki",   train="he_iahltwiki-ud-train.conllu", dev="he_iahltwiki-ud-dev.conllu", prefix="he", out="hebrew_iahltwiki"),
    dict(src_dir="UD_Latin-LLCT",         train="la_llct-ud-train.conllu",   dev="la_llct-ud-dev.conllu",   prefix="la",  out="latin_llct"),
    dict(src_dir="UD_Turkish-BOUN",       train="tr_boun-ud-train.conllu",   dev="tr_boun-ud-dev.conllu",   prefix="tr",  out="turkish_boun"),
    dict(src_dir="UD_Greek-GUD",          train="el_gud-ud-train.conllu",    dev=None,                      prefix="el",  out="modern_greek", split=True),
]
