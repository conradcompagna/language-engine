...
- Alternative-form surfaces scanned: 155,994
- Script family treated as in-family: Kanji/Han family + Hiragana + Katakana + Japanese iteration marks
- Counted as junk: codepoints outside that family whose Unicode category starts with `P`, `S`, `Z`, `M`, or `C`
- Explicitly excluded from this pass: letters from other scripts and decimal digits
- Distinct junk codepoints found: 210
- Total junk-codepoint occurrences: 8,943

| Glyph | Codepoint | Total | Headword | Alt form | Category | Unicode name | Sample surfaces |
| --- | --- | ---: | ---: | ---: | --- | --- | --- |
| [space] | `U+0020` | 5,169 | 3,669 | 1,500 | `Zs` | SPACE | San Marino; Rio de Janeiro; mein pēji; moshi moshi; ka na |
| - | `U+002D` | 2,261 | 1,208 | 1,053 | `Pd` | HYPHEN-MINUS | a-; dai-; -ai; ai-; -au |
| ' | `U+0027` | 432 | 291 | 141 | `Po` | APOSTROPHE | imo'; oto'; on'yomi; un'unhekishiumu; in'yō |
| . | `U+002E` | 267 | 112 | 155 | `Po` | FULL STOP | ..-; .--..; --.--; .-; -.--- |
| ` | `U+0060` | 108 | 96 | 12 | `Sk` | GRAVE ACCENT | `period`; `period``period`; (´・ω・`); ´・ω・`; (´･ω･`) |
| ( | `U+0028` | 44 | 26 | 18 | `Ps` | LEFT PARENTHESIS | (; ｷﾀ―――(ﾟ∀ﾟ)――――!!; ( ); ＼(^o^)／; (ry |
| ) | `U+0029` | 42 | 24 | 18 | `Pe` | RIGHT PARENTHESIS | ); ｷﾀ―――(ﾟ∀ﾟ)――――!!; ( ); ＼(^o^)／; (´・ω・`) |
| ○ | `U+25CB` | 39 | 12 | 27 | `So` | WHITE CIRCLE | ○; ○×; ま○こ; お○んこ; おま○こ |
| 、 | `U+3001` | 38 | 16 | 22 | `Po` | IDEOGRAPHIC COMMA | 茅萱、白茅; 、; 病は口より入り、禍は口より出ず; 瓜田に履を納れず、李下に冠を正さず; かでんにくつをいれず、りかにかんむりをたださず |
| … | `U+2026` | 27 | 11 | 16 | `Po` | HORIZONTAL ELLIPSIS | ま…こ; ……; ma…ko; 猶…ごとし; 由…ごとし |
| ~ | `U+007E` | 25 | 1 | 24 | `Sm` | TILDE | ~; (^_^)/~~~; (;_;)/~~~; (^.^)/~~~; (-_-)/~~~ |
| / | `U+002F` | 22 | 12 | 10 | `Po` | SOLIDUS | π/; (^^)/`tilde``tilde``tilde`; (^_^)/~~~; (;_;)/~~~; (^.^)/~~~ |
| ⠐ | `U+2810` | 20 | 20 | 0 | `So` | BRAILLE PATTERN DOTS-5 | ⠐⠡; ⠐⠣; ⠐⠩; ⠐⠫; ⠐⠪ |
| 〜 | `U+301C` | 20 | 2 | 18 | `Pd` | WAVE DASH | きゃ〜; キャ〜; 〜; ま〜; マ〜 |
| ^ | `U+005E` | 18 | 11 | 7 | `Sk` | CIRCUMFLEX ACCENT | ＼(^o^)／; _(_^_)_; `lowbar`(`lowbar`^`lowbar`)`lowbar`; (^^)/`tilde``tilde``tilde`; (^_^)/~~~ |
| _ | `U+005F` | 17 | 0 | 17 | `Pc` | LOW LINE | m(_ _)m; <(_ _)>; _(_^_)_; _(._.)_; (__) |
| @ | `U+0040` | 13 | 5 | 8 | `Po` | COMMERCIAL AT | @; (@^^)/~~~; (@^^)/`tilde``tilde``tilde` |
| ´ | `U+00B4` | 13 | 4 | 9 | `Sk` | ACUTE ACCENT | (´・ω・`); ´・ω・`; (´・ω・｀); (´･ω･`); （´・ω・｀） |
| & | `U+0026` | 11 | 6 | 5 | `Po` | AMPERSAND | &; R&B; ドラッグ&ドロップ; doraggu&doroppu; リズム&ブルース |
| , | `U+002C` | 7 | 7 | 0 | `Po` | COMMA | kita, mita, katta; bankoku no rōdōsha yo, danketsu seyo; kaden ni kutsu o irezu, rika ni kanmuri o tadasazu; hikari o tsutsumi, ato o kuramasu; ware omou, yue ni ware ari |
| ― | `U+2015` | 7 | 0 | 7 | `Pd` | HORIZONTAL BAR | ｷﾀ―――(ﾟ∀ﾟ)――――!! |
| ｀ | `U+FF40` | 7 | 2 | 5 | `Sk` | FULLWIDTH GRAVE ACCENT | (´・ω・｀); （´・ω・｀）; ´・ω・｀ |
| = | `U+003D` | 6 | 2 | 4 | `Sm` | EQUALS SIGN | = |
| ◎ | `U+25CE` | 6 | 3 | 3 | `So` | BULLSEYE | ま◎こ; お◎んこ; ◎ |
| ● | `U+25CF` | 6 | 3 | 3 | `So` | BLACK CIRCLE | ま●こ; おま●こ; ● |
| ◯ | `U+25EF` | 6 | 2 | 4 | `So` | LARGE CIRCLE | ま◯こ; セッ◯ス |
| ？ | `U+FF1F` | 6 | 6 | 0 | `Po` | FULLWIDTH QUESTION MARK | ご飯にする？お風呂にする？それとも私？; なにそれ？おいしいの？; そマ？ |
| * | `U+002A` | 5 | 2 | 3 | `Po` | ASTERISK | ま*こ; ma*ko |
| ? | `U+003F` | 5 | 3 | 2 | `Po` | QUESTION MARK | nani sore? oishii no?; nansai desu ka? |
| × | `U+00D7` | 5 | 3 | 2 | `Sm` | MULTIPLICATION SIGN | ×; ○×; ○×ゲーム; ×いち; ×イチ |
| ⠠ | `U+2820` | 5 | 5 | 0 | `So` | BRAILLE PATTERN DOTS-6 | ⠠⠥; ⠠⠧; ⠠⠭; ⠠⠯; ⠠⠮ |
| （ | `U+FF08` | 5 | 1 | 4 | `Ps` | FULLWIDTH LEFT PARENTHESIS | （日）; （´・ω・｀）; （自主規制） |
| ） | `U+FF09` | 5 | 1 | 4 | `Pe` | FULLWIDTH RIGHT PARENTHESIS | （日）; （´・ω・｀）; （自主規制） |
| + | `U+002B` | 4 | 4 | 0 | `Sm` | PLUS SIGN | C++; +α |
| ; | `U+003B` | 4 | 2 | 2 | `Po` | SEMICOLON | (;_;)/~~~; (;`lowbar`;)/`tilde``tilde``tilde` |
| [ | `U+005B` | 4 | 0 | 4 | `Ps` | LEFT SQUARE BRACKET | [[#Japanese\|]]; [Alt: ⿰𩵋⿱山⿵𠘨丶]; [Alt: ⿰冫嵐] |
| ] | `U+005D` | 4 | 0 | 4 | `Pe` | RIGHT SQUARE BRACKET | [[#Japanese\|]]; [Alt: ⿰𩵋⿱山⿵𠘨丶]; [Alt: ⿰冫嵐] |
| · | `U+00B7` | 4 | 2 | 2 | `Po` | MIDDLE DOT | ($··)/~~~; ($··)/`tilde``tilde``tilde` |
| ☆ | `U+2606` | 4 | 2 | 2 | `So` | WHITE STAR | ま☆こ; ☆彡 |
| 。 | `U+3002` | 4 | 4 | 0 | `Po` | IDEOGRAPHIC FULL STOP | 。; 。。。 |
...
| ㈪ | `U+322A` | 3 | 1 | 2 | `So` | PARENTHESIZED IDEOGRAPH MOON | ㈪ |
| ㈫ | `U+322B` | 3 | 1 | 2 | `So` | PARENTHESIZED IDEOGRAPH FIRE | ㈫ |
| ㈬ | `U+322C` | 3 | 1 | 2 | `So` | PARENTHESIZED IDEOGRAPH WATER | ㈬ |
| ㈭ | `U+322D` | 3 | 1 | 2 | `So` | PARENTHESIZED IDEOGRAPH WOOD | ㈭ |
| ㈮ | `U+322E` | 3 | 1 | 2 | `So` | PARENTHESIZED IDEOGRAPH METAL | ㈮ |
| ㈯ | `U+322F` | 3 | 1 | 2 | `So` | PARENTHESIZED IDEOGRAPH EARTH | ㈯ |
| ㈰ | `U+3230` | 3 | 1 | 2 | `So` | PARENTHESIZED IDEOGRAPH SUN | ㈰ |
| ㊊ | `U+328A` | 3 | 1 | 2 | `So` | CIRCLED IDEOGRAPH MOON | ㊊ |
| ㊋ | `U+328B` | 3 | 1 | 2 | `So` | CIRCLED IDEOGRAPH FIRE | ㊋ |
| ㊌ | `U+328C` | 3 | 1 | 2 | `So` | CIRCLED IDEOGRAPH WATER | ㊌ |
| ㊍ | `U+328D` | 3 | 1 | 2 | `So` | CIRCLED IDEOGRAPH WOOD | ㊍ |
| ㊎ | `U+328E` | 3 | 1 | 2 | `So` | CIRCLED IDEOGRAPH METAL | ㊎ |
| ㊏ | `U+328F` | 3 | 1 | 2 | `So` | CIRCLED IDEOGRAPH EARTH | ㊏ |
| ㊐ | `U+3290` | 3 | 1 | 2 | `So` | CIRCLED IDEOGRAPH SUN | ㊐ |
| ㌠ | `U+3320` | 3 | 1 | 2 | `So` | SQUARE SANTIIMU | ㌠ |
| ～ | `U+FF5E` | 3 | 0 | 3 | `Sm` | FULLWIDTH TILDE | ～ |
| ! | `U+0021` | 2 | 0 | 2 | `Po` | EXCLAMATION MARK | ｷﾀ―――(ﾟ∀ﾟ)――――!! |
| $ | `U+0024` | 2 | 1 | 1 | `Sc` | DOLLAR SIGN | ($··)/~~~; ($··)/`tilde``tilde``tilde` |
| % | `U+0025` | 2 | 0 | 2 | `Po` | PERCENT SIGN | % |
| : | `U+003A` | 2 | 0 | 2 | `Po` | COLON | [Alt: ⿰𩵋⿱山⿵𠘨丶]; [Alt: ⿰冫嵐] |
| © | `U+00A9` | 2 | 1 | 1 | `So` | COPYRIGHT SIGN | © |
...
| 【 | `U+3010` | 2 | 1 | 1 | `Ps` | LEFT BLACK LENTICULAR BRACKET | 【 】; 【自主規制】 |
| 】 | `U+3011` | 2 | 1 | 1 | `Pe` | RIGHT BLACK LENTICULAR BRACKET | 【 】; 【自主規制】 |
| 〝 | `U+301D` | 2 | 2 | 0 | `Ps` | REVERSED DOUBLE PRIME QUOTATION MARK | 〝 〟; 〝 〞 |
| ㈱ | `U+3231` | 2 | 1 | 1 | `So` | PARENTHESIZED IDEOGRAPH STOCK | ㈱ |
| [control/format] | `U+32501` | 2 | 1 | 1 | `Cn` | <unnamed> | 𲔁 |
| [control/format] | `U+33143` | 2 | 1 | 1 | `Cn` | <unnamed> | 𳅃 |
...
| △ | `U+25B3` | 1 | 1 | 0 | `So` | WHITE UP-POINTING TRIANGLE | △ |
...
| ◐ | `U+25D0` | 1 | 1 | 0 | `So` | CIRCLE WITH LEFT HALF BLACK | ◐ |
| ◑ | `U+25D1` | 1 | 1 | 0 | `So` | CIRCLE WITH RIGHT HALF BLACK | ◑ |
...
| ／ | `U+FF0F` | 1 | 1 | 0 | `Po` | FULLWIDTH SOLIDUS | ＼(^o^)／ |
| ＝ | `U+FF1D` | 1 | 0 | 1 | `Sm` | FULLWIDTH EQUALS SIGN | ＝ |
| ＼ | `U+FF3C` | 1 | 1 | 0 | `Po` | FULLWIDTH REVERSE SOLIDUS | ＼(^o^)／ |
