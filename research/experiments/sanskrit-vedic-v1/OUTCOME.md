...
The run completed and produced weights. They are not what the service loads.
...
This is the clearest case for why `research/tools/check_provenance.py` exists: the
deployed model is *named* `sanskrit-vedic`, but it was not produced by the Vedic run.
